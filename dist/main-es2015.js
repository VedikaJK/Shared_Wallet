...
/* harmony default export */ __webpack_exports__["default"] = ("<mat-toolbar color=\"primary\">Simple Shared Wallet</mat-toolbar>\n<app-meta-sender></app-meta-sender>\n");
...
/* harmony import */ var _simple_simplewallet_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./simple/simplewallet.module */ "./src/app/simple/simplewallet.module.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _simple_simplewallet_module__WEBPACK_IMPORTED_MODULE_6__["SimpleModule"]
        ],
        providers: [],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SimpleWalletComponent", function() { return SimpleWalletComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
const simplewallet_artifacts = __webpack_require__(/*! ../../../../build/contracts/SimpleWallet.json */ "./build/contracts/SimpleWallet.json");
let SimpleWalletComponent = class SimpleWalletComponent {
    ...
    watchAccount() {
        this.web3Service.accountsObservable.subscribe((accounts) => {
            ...
            this.refreshBalance();
            this.SimpleWallet.deployed().then((i) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                const isAllowed = yield i.CheckIfAllowed(this.model.account);
                if (isAllowed) {
    ...
    addAllowedAddress() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                const instance = yield this.SimpleWallet.deployed();
                const transaction = yield instance.AllowAddressToSendFunds(whitelistAddress, { from: this.model.account });
                if (!transaction) {
    ...
    removeAllowedAddress() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                const instance = yield this.SimpleWallet.deployed();
                const transaction = yield instance.DisallowAddressToSendFunds(blacklistAddress, { from: this.model.account });
                if (!transaction) {
                    this.setStatus('Transaction failed!');
                }
                else {
    ...
    refreshBalance() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                const deployedSimpleWallet = yield this.SimpleWallet.deployed();
                console.log(deployedSimpleWallet);
                console.log('Account', this.model.account);
                const simpleWalletBalance = yield this.web3Service.getWeb3().then(web3 => { return web3.eth.getBalance(deployedSimpleWallet.address); });
    ...
    sendFromWallet() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                const instance = yield this.SimpleWallet.deployed();
                const web3 = yield this.web3Service.getWeb3();
                console.log('That is in Wei : ' + web3.utils.toWei(amount, "ether") + ' Ether');
                const transaction = yield instance.sendFunds(web3.utils.toWei(amount, "ether"), receiver, { from: this.model.account });
                if (!transaction) {
                    this.setStatus('Transaction failed!');
                }
                else {
    ...
    DepositEther() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            try {
                const deployedSimpleWallet = yield this.SimpleWallet.deployed();
                const transaction = yield deployedSimpleWallet.sendTransaction({ from: this.model.account, value: this.SimpleWallet.web3.utils.toWei(amount, "Ether") });
                if (!transaction) {
                    this.setStatus('Transaction failed!');
                }
                else {
...
SimpleWalletComponent.ctorParameters = () => [
    { type: _util_web3_service__WEBPACK_IMPORTED_MODULE_2__["Web3Service"] },
    { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"] }
];
SimpleWalletComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-meta-sender',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./simple-wallet.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/simple/simple-wallet/simple-wallet.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./simple-wallet.component.css */ "./src/app/simple/simple-wallet/simple-wallet.component.css")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_util_web3_service__WEBPACK_IMPORTED_MODULE_2__["Web3Service"], _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_3__["MatSnackBar"]])
...
/* harmony import */ var _simple_wallet_simple_wallet_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./simple-wallet/simple-wallet.component */ "./src/app/simple/simple-wallet/simple-wallet.component.ts");
...
SimpleModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let Web3Service = class Web3Service {
    ...
    artifactsToContract(artifacts) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const contractAbstraction = truffle_contract__WEBPACK_IMPORTED_MODULE_2___default()(artifacts);
...
module.exports = __webpack_require__(/*! C:\angbox_\src\main.ts */"./src/main.ts");
